...
# I tried to get normalized counts for cells from each cluster in every dataset
# and calculate the mean normalized counts for each gene for every cluster. Then,
# I removed the genes with zero counts in all samples and scaled the values
...
# The results were completely wrong. 

# Hence, it is better to find identical clusters across datasets using 
# Seurat::FindAllMarkers(). 

# NOTE: If you use all the markers you get Seurat::FindAllMarkers() directly to 
# identify similar clusters across datasets, results are completely wrong.
# YOU MUST FILTER OUT POOR/WEAK markers and use ONLY top 100 or 75 markers for
# each cluster to identify similar clusters. I have observed that the more 
# markers you use, the worse the results
...
for (proj in projects){
  ...
  openxlsx::saveWorkbook(wb = wb, file = "All Markers for 7 datasets.xlsx", overwrite = TRUE)
}
